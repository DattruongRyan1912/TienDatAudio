    ...
    <div className="sonic-page pt-28 md:pt-36">
      ...
      <div className="sonic-container">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[1.05fr_.95fr] lg:gap-16">
          <SonicReveal direction="left"><SonicProductGallery images={product.images} name={product.name} /></SonicReveal>
          <SonicReveal direction="right" delay={0.1} className="flex flex-col justify-center">
