...
type Overview = {
  rollout: string
  flags: { exactFacts: boolean; tools: boolean; knowledge: boolean; advisor: boolean; conversations: boolean; graphMode: string }
