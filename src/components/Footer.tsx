          ...
          <motion.div variants={itemVariants} className="lg:col-span-1">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{settings?.siteDescription || 'Thiết bị âm thanh chuyên nghiệp'}</p>
              </div>
            </motion.div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-gray-200">{settings?.contactPhone || '+84 123 456 789'}</span>
              </motion.div>
              <motion.div 
                className="flex items-center space-x-3"
                whileHover={{ x: 5 }}
              ...
              >
                ...
                <span className="text-gray-200">{settings?.contactEmail || 'info@tiendataudio.com'}</span>
              </motion.div>
              <motion.div 
                className="flex items-center space-x-3"
                whileHover={{ x: 5 }}
              ...
              >
                ...
                <span className="text-gray-200">{settings?.address || '123 Đường ABC, Quận XYZ, TP.HCM'}</span>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <p className="text-gray-400 text-sm">
                © 2024 {settings?.siteName || 'Tiến Đạt Audio'}. Tất cả quyền được bảo lưu.
              </p>
