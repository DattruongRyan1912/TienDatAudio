...
import { Globe2, MoreHorizontal, Verified } from 'lucide-react'
      ...
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-1.5">
            ...
            {author.verified && <Verified size={14} className="shrink-0 fill-[var(--sonic-gold)] text-[var(--sonic-gold)]" aria-label="Đã xác minh" />}
          </div>
